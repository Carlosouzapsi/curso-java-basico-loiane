...
public class JogoDaVelha {
	...
	boolean verificarGanhador(char sinal) {
		...
		if((jogoVelha[0][0] == sinal && jogoVelha[0][1] == sinal && jogoVelha[0][2] == sinal) || //linha 1
				...
				(jogoVelha[1][0] == sinal && jogoVelha[1][1] == sinal && jogoVelha[2][2] == sinal) || // linha 3
				...
				(jogoVelha[0][1] == sinal && jogoVelha[1][2] == sinal && jogoVelha[2][2] == sinal) || // coluna 3
				(jogoVelha[0][1] == sinal && jogoVelha[1][2] == sinal && jogoVelha[2][2] == sinal))   //Diagonal  
		{
			return true;
